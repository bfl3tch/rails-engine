...
namespace :csv_load do
  ...
  task create_customers: :environment do
    CSV.foreach('./db/csvs/customers.csv', headers: true) do |row|
  ...
  task create_merchants: :environment do
    CSV.foreach('./db/csvs/merchants.csv', headers: true) do |row|
  ...
  task create_items: :environment do
    CSV.foreach('./db/csvs/items.csv', headers: true) do |row|
  ...
  task create_invoices: :environment do
    CSV.foreach('./db/csvs/invoices.csv', headers: true) do |row|
  ...
  task create_transactions: :environment do
    CSV.foreach('./db/csvs/transactions.csv', headers: true) do |row|
  ...
  task create_invoice_items: :environment do
    CSV.foreach('./db/csvs/invoice_items.csv', headers: true) do |row|
