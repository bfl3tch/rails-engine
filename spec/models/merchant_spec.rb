  ...
  describe 'class methods' do
    ...
    describe '::merchant_revenue' do
      it 'returns the revenue for one merchant' do
        ...
        expect(Merchant.merchant_revenue(merchant_1.id).first.revenue).to eq(55)
      end
      ...
      it 'returns the revenue for one merchant with floats' do
        ...
        expect(Merchant.merchant_revenue(merchant_1.id).first.revenue).to eq(3629.2000000000003)
      end
    end
